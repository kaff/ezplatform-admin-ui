...
class AutosaveEnabled implements ValueDefinitionInterface, FormMapperInterface
{
    ...
    private function getTranslatedName(): string
    {
        return $this->translator->trans(
            /** @Desc("Autosave draft") */
            'settings.autosave_enabled.value.title',
            [],
            'user_settings'
        );
    }
    ...
    private function getTranslatedDescription(): string
    {
        return $this->translator->trans(
            ...
            'settings.autosave_enabled.value.description',
            [],
            'user_settings'
        );
    }
    ...
    private function getTranslatedOptionEnabled(): string
    {
        return $this->translator->trans(
            /** @Desc("enabled") */
            'settings.autosave_enabled.value.enabled',
            [],
            'user_settings'
        );
    }
    ...
    private function getTranslatedOptionDisabled(): string
    {
        return $this->translator->trans(
            /** @Desc("disabled") */
            'settings.autosave_enabled.value.disabled',
            [],
            'user_settings'
        );
    }
