(function(global, doc, eZ, Translator) {
    ...
    const isAutosaveEnabled = () => {
        const autosaveSubmitBtn = form.querySelector('[name="ezplatform_content_forms_content_edit[autosave]"]');

        return eZ.adminUiConfig.autosave.enabled && autosaveSubmitBtn;
    };
